...
<html lang="en" dir="ltr">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input value="<?php echo ($result['title']); ?>" type="text" name="title" required  lay-verify="required" placeholder="请输入类型标题" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-inline">
      <input value="<?php echo ($result['logo']); ?>" id="img_input" type="text" name="logo" required  lay-verify="required" placeholder="资源路径" autocomplete="off" class="layui-input">
    </div>
    ...
    <br>
    <img height="80" id='img_show' src="<?php echo ($result['logo']); ?>" alt="">
  </div>

  <div class="layui-form-item">
    <label class="layui-form-label">提示</label>
    <div class="layui-input-block">
      <input value="<?php echo ($result['tip']); ?>" type="text" name="tip" required  lay-verify="required" placeholder="请输入提示" autocomplete="off" class="layui-input">
    </div>
  </div>
